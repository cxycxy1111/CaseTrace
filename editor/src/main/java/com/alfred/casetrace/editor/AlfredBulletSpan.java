...
public class AlfredBulletSpan extends BulletSpan {
    ...
    public AlfredBulletSpan(int bulletColor, int bulletRadius, int bulletGapWidth) {
    ...
    public AlfredBulletSpan(Parcel src) {
        super(src);
