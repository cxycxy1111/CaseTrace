...
public class AlfredQuoteSpan extends QuoteSpan {
    ...
    public AlfredQuoteSpan(int quoteColor, int quoteStripeWidth, int quoteGapWidth) {
    ...
    public AlfredQuoteSpan(Parcel src) {
        super(src);
